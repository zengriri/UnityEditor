...
{
    public partial class DragAndDropWindowBetween : EditorWindow
    {
        ...
        [MenuItem("Planets/Drag/DragAndDropBetween")]
        public static void OpenDragAndDropWindows()
        {
            // Create the windows.
            var windowA = CreateInstance<DragAndDropWindowBetween>();
            var windowB = CreateInstance<DragAndDropWindowBetween>();
