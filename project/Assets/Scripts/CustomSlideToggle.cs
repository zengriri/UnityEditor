...
namespace Custom
{
    ...
    public class CustomSlideToggle : BaseField<bool>
    {
        public new class UxmlFactory : UxmlFactory<CustomSlideToggle, UxmlTraits> { }
        ...
        // class.
        public CustomSlideToggle() : this(null) { }

        // This constructor allows users to set the contents of the label.
        public CustomSlideToggle(string label) : base(label, null)
        {
        ...
        {
            var slideToggle = evt.currentTarget as CustomSlideToggle;
